...
Etsy's mobile site is built for people who already know how to use Etsy. For a first-time visitor, the structure is overwhelming — dozens of categories, deep subcategories, navigation that assumes you know where things live. The goal: redesign the information architecture to make the site navigable for new users.
